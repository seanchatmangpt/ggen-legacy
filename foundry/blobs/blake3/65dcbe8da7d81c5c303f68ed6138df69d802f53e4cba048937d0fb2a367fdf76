...
- [ggen v5.0.2 - DEB + gVisor Deployment and Operations Runbook](#ggen-v502---deb--gvisor-deployment-and-operations-runbook)
  - [Table of Contents](#table-of-contents)
  - [Pre-Deployment Checklist](#pre-deployment-checklist)
    - [System Requirements](#system-requirements)
    - [Security Requirements](#security-requirements)
    - [Pre-Deployment Validation](#pre-deployment-validation)
    - [Dependencies Checklist](#dependencies-checklist)
    - [Deployment Decision Matrix](#deployment-decision-matrix)
  - [Installation & Deployment Guide](#installation--deployment-guide)
    - [Method 1: Direct DEB Installation (Recommended for Development)](#method-1-direct-deb-installation-recommended-for-development)
    - [Method 2: Docker + gVisor Deployment](#method-2-docker--gvisor-deployment)
    - [Method 3: Kubernetes + gVisor Runtime Class](#method-3-kubernetes--gvisor-runtime-class)
    - [Method 4: Full DEB + gVisor Pipeline (8-Phase Build)](#method-4-full-deb--gvisor-pipeline-8-phase-build)
  - [Configuration Reference](#configuration-reference)
    - [Environment Variables](#environment-variables)
    - [ggen.toml Configuration](#ggentoml-configuration)
    - [gVisor Runtime Configuration](#gvisor-runtime-configuration)
  ...
  - [Operational Procedures](#operational-procedures)
    - [Standard Operating Procedures (SOPs)](#standard-operating-procedures-sops)
      - [SOP-001: Daily Health Check](#sop-001-daily-health-check)
      - [SOP-002: Pipeline Execution](#sop-002-pipeline-execution)
      - [SOP-003: Backup and Recovery](#sop-003-backup-and-recovery)
    - [Monitoring Procedures](#monitoring-procedures)
      - [Collect Metrics](#collect-metrics)
      - [Log Collection](#log-collection)
  - [Runbooks](#runbooks)
    - [Runbook 1: Partial Pipeline Re-run](#runbook-1-partial-pipeline-re-run)
    - [Runbook 2: Emergency Rollback](#runbook-2-emergency-rollback)
    - [Runbook 3: Debugging Pipeline Failures](#runbook-3-debugging-pipeline-failures)
    - [Runbook 4: gVisor Runtime Failures](#runbook-4-gvisor-runtime-failures)
    - [Runbook 5: Performance Degradation](#runbook-5-performance-degradation)
    - [Runbook 6: Artifact Corruption / Integrity Issues](#runbook-6-artifact-corruption--integrity-issues)
    - [Runbook 7: Disk Space Exhaustion](#runbook-7-disk-space-exhaustion)
    - [Runbook 8: Handling Security Vulnerabilities](#runbook-8-handling-security-vulnerabilities)
    - [Runbook 9: CI/CD Pipeline Integration](#runbook-9-cicd-pipeline-integration)
    - [Runbook 10: Scaling for High-Volume Workloads](#runbook-10-scaling-for-high-volume-workloads)
  ...
  - [FAQ & Troubleshooting](#faq--troubleshooting)
    ...
    - [Common Issues and Solutions](#common-issues-and-solutions)
      - [Issue: "error: could not compile `ggen` (lib) due to 3 previous errors"](#issue-error-could-not-compile-ggen-lib-due-to-3-previous-errors)
      - [Issue: "dpkg: error processing package ggen"](#issue-dpkg-error-processing-package-ggen)
      - [Issue: "ggen: command not found" after installation](#issue-ggen-command-not-found-after-installation)
      - [Issue: "Permission denied" when running ggen](#issue-permission-denied-when-running-ggen)
      - [Issue: Pipeline times out or hangs](#issue-pipeline-times-out-or-hangs)
      - [Issue: "runsc: command not found"](#issue-runsc-command-not-found)
      - [Issue: Docker "unknown runtime specified runsc"](#issue-docker-unknown-runtime-specified-runsc)
      - [Issue: "No space left on device"](#issue-no-space-left-on-device)
